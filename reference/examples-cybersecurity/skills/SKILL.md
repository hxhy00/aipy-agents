...
After installation, create links to make it available in AiPy:

**For regular environments:**
```bash
ln -sf ~/.agents/skills/<skill-name> ~/.aipyapp/skills/<skill-name>
```

**For virtual machine environments:**
```bash
cp -r ~/.agents/skills/<skill-name> ~/.aipyapp/skills/<skill-name>
```
...
### Create Links for AiPy Access

After installation, create appropriate links to make skills available in AiPy:
